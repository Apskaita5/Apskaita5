...
Friend Class F_OperationAmortizationPeriodChange
    ...
    Private WithEvents _FormManager As CslaActionExtenderEditForm(Of OperationAmortizationPeriodChange)
    Private _QueryManager As CslaActionExtenderQueryObject

    Private _DocumentToEdit As OperationAmortizationPeriodChange = Nothing
    ...
    Public Sub New(ByVal documentToEdit As OperationAmortizationPeriodChange)
    ...
    Private Sub F_OperationAmortizationPeriodChange_Load(ByVal sender As System.Object, _
        ...
        If _DocumentToEdit Is Nothing Then
            'OperationAmortizationPeriodChange.NewOperationAmortizationPeriodChange(_AssetID)
            _QueryManager.InvokeQuery(Of OperationAmortizationPeriodChange)(Nothing, _
                "NewOperationAmortizationPeriodChange", True, AddressOf OnNewOperationLoaded, _AssetID)
        Else
    ...
    Private Function SetDataSources() As Boolean
        ...
        Try
            ...
            BackgroundInfoPanel1.GetBindingSource.DataSource = OperationAmortizationPeriodChangeBindingSource
    ...
    Private Sub InitializeFormManager()
        ...
        Try
            _FormManager = New CslaActionExtenderEditForm(Of OperationAmortizationPeriodChange) _
    ...
    Private Sub OnNewOperationLoaded(ByVal result As Object, ByVal exceptionHandled As Boolean)
        ...
        _DocumentToEdit = DirectCast(result, OperationAmortizationPeriodChange)
