...
Public Class F_OperationOperationalStatusChange
    Implements ISupportsPrinting, IObjectEditForm

    Private Obj As OperationOperationalStatusChange
    ...
    Public Sub New(ByVal assetId As Integer, ByVal beginOperationalPeriod As Boolean)
    ...
    Private Sub F_OperationOperationalStatusChange_Activated(ByVal sender As Object, _
    ...
    Private Sub F_OperationOperationalStatusChange_FormClosing(ByVal sender As Object, _
    ...
    Private Sub F_OperationOperationalStatusChange_Load(ByVal sender As System.Object, _
        ...
        Try
            If _OperationID > 0 Then
                Obj = LoadObject(Of OperationOperationalStatusChange)(Nothing, _
                    "GetOperationOperationalStatusChange", True, _OperationID)
            ElseIf _AssetID > 0 Then
                Obj = LoadObject(Of OperationOperationalStatusChange)(Nothing, _
                    "NewOperationOperationalStatusChange", True, _AssetID, _BeginOperationalPeriod)
            Else
        ...
        OperationOperationalStatusChangeBindingSource.DataSource = Obj
    ...
    Private Function SaveObj() As Boolean
        ...
        Using cm As New BindingsManager(BackgroundInfoPanel1.GetBindingSource, _
            ...
            Using bm As New BindingsManager(OperationOperationalStatusChangeBindingSource, _
                Nothing, Nothing, True, False)

                Try
                    Obj = LoadObject(Of OperationOperationalStatusChange)(Obj, "Save", False)
                Catch ex As Exception
                    ShowError(ex)
                    Return False
                End Try
