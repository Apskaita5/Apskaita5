...
Public Class F_OperationAccountChange
    Implements ISupportsPrinting, IObjectEditForm

    Private Obj As OperationAccountChange
    ...
    Public Sub New(ByVal assetID As Integer, ByVal accountType As LtaAccountChangeType)
    ...
    Private Sub F_OperationAccountChange_Activated(ByVal sender As Object, _
    ...
    Private Sub F_OperationAccountChange_FormClosing(ByVal sender As Object, _
    ...
    Private Sub F_OperationAccountChange_Load(ByVal sender As System.Object, _
        ...
        Try
            If _OperationID > 0 Then
                Obj = LoadObject(Of OperationAccountChange)(Nothing, _
                    "GetOperationAccountChange", True, _OperationID, _FetchByJournalEntry)
            ElseIf _AssetID > 0 Then
                Obj = LoadObject(Of OperationAccountChange)(Nothing, _
                    "NewOperationAccountChange", True, _AssetID, _AccountType)
            Else
        ...
        OperationAccountChangeBindingSource.DataSource = Obj
    ...
    Private Function SaveObj() As Boolean
        ...
        Using cm As New BindingsManager(BackgroundInfoPanel1.GetBindingSource, _
            ...
            Using bm As New BindingsManager(OperationAccountChangeBindingSource, _
                Nothing, Nothing, True, False)

                Try
                    Obj = LoadObject(Of OperationAccountChange)(Obj, "Save", False)
                Catch ex As Exception
                    ShowError(ex)
                    Return False
                End Try
    ...
    Private Function SetDataSources() As Boolean
        ...
        Try
            ...
            LoadAccountInfoListToGridCombo(NewAccountAccGridComboBox, True, 1)
    ...
    Private Sub ConfigureButtons()
        ...
        NewAccountAccGridComboBox.Enabled = (Not Obj Is Nothing AndAlso Not Obj.NewAccountIsReadOnly)
