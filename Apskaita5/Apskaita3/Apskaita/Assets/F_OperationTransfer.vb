...
Public Class F_OperationTransfer
    Implements ISupportsPrinting, IObjectEditForm

    Private Obj As OperationTransfer
    ...
    Public Sub New(ByVal childObj As OperationTransfer)
    ...
    Private Sub F_OperationTransfer_Activated(ByVal sender As Object, _
    ...
    Private Sub F_OperationTransfer_FormClosing(ByVal sender As Object, _
    ...
    Private Sub F_OperationTransfer_Load(ByVal sender As System.Object, _
        ...
        Try
            If Obj Is Nothing OrElse Not Obj.IsChild Then
                If _OperationID > 0 Then
                    Obj = LoadObject(Of OperationTransfer)(Nothing, _
                        "GetOperationTransfer", True, _OperationID, _FetchByJournalEntry)
                ElseIf _AssetID > 0 Then
                    Obj = LoadObject(Of OperationTransfer)(Nothing, _
                        "NewOperationTransfer", True, _AssetID)
                Else
        ...
        OperationTransferBindingSource.DataSource = Obj
    ...
    Private Sub OkButton_Click(ByVal sender As System.Object, _
        ...
        If Obj.IsChild Then
            ...
            BindingsManager.UnBind(True, False, New BindingSource() _
                {OperationTransferBindingSource, BackgroundInfoPanel1.GetBindingSource()})
            Obj.ApplyEdit()
    ...
    Private Function SaveObj() As Boolean
        ...
        Using cm As New BindingsManager(BackgroundInfoPanel1.GetBindingSource, _
            ...
            Using bm As New BindingsManager(OperationTransferBindingSource, _
                Nothing, Nothing, True, False)

                Try
                    Obj = LoadObject(Of OperationTransfer)(Obj, "Save", False)
                Catch ex As Exception
                    ShowError(ex)
                    Return False
                End Try
    ...
    Private Sub ConfigureButtons()
        ...
        AmountToTransferAccTextBox.ReadOnly = (Obj Is Nothing OrElse Obj.AmountToTransferIsReadOnly)
