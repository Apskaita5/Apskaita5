...
Public Class F_OperationAcquisitionValueIncrease
    Implements ISupportsPrinting, IObjectEditForm

    Private Obj As OperationAcquisitionValueIncrease
    ...
    Public Sub New(ByVal childObj As OperationAcquisitionValueIncrease)
    ...
    Private Sub F_OperationAcquisitionValueIncrease_Activated(ByVal sender As Object, _
    ...
    Private Sub F_OperationAcquisitionValueIncrease_FormClosing(ByVal sender As Object, _
    ...
    Private Sub F_OperationAcquisitionValueIncrease_Load(ByVal sender As System.Object, _
        ...
        Try
            If Obj Is Nothing OrElse Not Obj.IsChild Then
                If _OperationID > 0 Then
                    Obj = LoadObject(Of OperationAcquisitionValueIncrease)(Nothing, _
                        "GetOperationAcquisitionValueIncrease", True, _OperationID, _FetchByJournalEntry)
                ElseIf _AssetID > 0 Then
                    Obj = LoadObject(Of OperationAcquisitionValueIncrease)(Nothing, _
                        "NewOperationAcquisitionValueIncrease", True, _AssetID)
                Else
        ...
        If Obj.IsChild Then Obj.BeginEdit()

        OperationAcquisitionValueIncreaseBindingSource.DataSource = Obj
    ...
    Private Sub OkButton_Click(ByVal sender As System.Object, _
        ...
        If Obj.IsChild Then
            ...
            If Not Obj.IsValid Then
                If Not YesOrNo("Formoje yra klaidų:" & vbCrLf & Obj.GetAllBrokenRules _
                    & vbCrLf & "Ar tikrai norite uždaryti formą?") Then Exit Sub
            End If

            BindingsManager.UnBind(True, False, New BindingSource() _
                {OperationAcquisitionValueIncreaseBindingSource, BackgroundInfoPanel1.GetBindingSource()})
            Obj.ApplyEdit()
    ...
    Private Sub ApplyButton_Click(ByVal sender As System.Object, _
        ...
        If Obj Is Nothing OrElse Obj.IsChild Then Exit Sub
    ...
    Private Sub CancelButton_Click(ByVal sender As System.Object, _
        ...
        If Obj.IsChild Then
            ...
            BindingsManager.UnBind(True, True, New BindingSource() _
                {OperationAcquisitionValueIncreaseBindingSource, BackgroundInfoPanel1.GetBindingSource()})
            Obj.CancelEdit()
            Me.Hide()
            Me.Close()
    ...
    Private Function SaveObj() As Boolean
        ...
        Using cm As New BindingsManager(BackgroundInfoPanel1.GetBindingSource, _
            ...
            Using bm As New BindingsManager(OperationAcquisitionValueIncreaseBindingSource, _
                Nothing, Nothing, True, False)

                Try
                    Obj = LoadObject(Of OperationAcquisitionValueIncrease)(Obj, "Save", False)
                Catch ex As Exception
                    ShowError(ex)
                    Return False
                End Try
    ...
    Private Sub ConfigureButtons()
        ...
        ValueIncreaseAccTextBox.ReadOnly = (Obj Is Nothing OrElse Obj.ValueIncreaseIsReadOnly)
