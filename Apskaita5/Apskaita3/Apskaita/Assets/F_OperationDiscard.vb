...
Public Class F_OperationDiscard
    Implements ISupportsPrinting, IObjectEditForm

    Private Obj As OperationDiscard
    ...
    Private Sub F_OperationDiscard_Activated(ByVal sender As Object, _
    ...
    Private Sub F_OperationDiscard_FormClosing(ByVal sender As Object, _
    ...
    Private Sub F_OperationDiscard_Load(ByVal sender As System.Object, _
        ...
        Try
            If _OperationID > 0 Then
                Obj = LoadObject(Of OperationDiscard)(Nothing, _
                    "GetOperationDiscard", True, _OperationID, _FetchByJournalEntry)
            ElseIf _AssetID > 0 Then
                Obj = LoadObject(Of OperationDiscard)(Nothing, _
                    "NewOperationDiscard", True, _AssetID)
            Else
        ...
        OperationDiscardBindingSource.DataSource = Obj
    ...
    Private Function SaveObj() As Boolean
        ...
        Using cm As New BindingsManager(BackgroundInfoPanel1.GetBindingSource, _
            ...
            Using bm As New BindingsManager(OperationDiscardBindingSource, _
                Nothing, Nothing, True, False)

                Try
                    Obj = LoadObject(Of OperationDiscard)(Obj, "Save", False)
                Catch ex As Exception
                    ShowError(ex)
                    Return False
                End Try
    ...
    Private Sub ConfigureButtons()
        ...
        AmountToDiscardAccTextBox.ReadOnly = (Obj Is Nothing OrElse Obj.AmountToDiscardIsReadOnly)
