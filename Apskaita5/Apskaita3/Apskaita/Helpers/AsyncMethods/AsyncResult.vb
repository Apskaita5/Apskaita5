Public Class AsyncResult
    ...
    Public Sub New(ByVal nObjectInstance As Object, ByVal nObjectType As Type, _
        ByVal nGlobalContext As System.Collections.Specialized.HybridDictionary, _
        ByVal nException As Exception)
        _ObjectInstance = nObjectInstance
        _ObjectType = nObjectType
        _GlobalContext = nGlobalContext
