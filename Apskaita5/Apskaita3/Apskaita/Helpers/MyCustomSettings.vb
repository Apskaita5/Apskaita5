...
#Region " Factory And Data Access Methods "
        ...
        Private Sub FetchMySettingsDefault()
            ...
            _UseThreadingForDataTransfer = Boolean.Parse(My.Settings.Properties("UseThreadingForDataTransfer").DefaultValue)
            _AutoReloadData = Boolean.Parse(My.Settings.Properties("AutoReloadData").DefaultValue)
            ...
            _UseSslForEmail = Boolean.Parse(My.Settings.Properties("UseSslForEmail").DefaultValue)
            _UseAuthForEmail = Boolean.Parse(My.Settings.Properties("UseAuthForEmail").DefaultValue)
            _SmtpPort = DirectCast(My.Settings.Properties("SmtpPort").DefaultValue, String)
            _ShowToolStrip = Boolean.Parse(My.Settings.Properties("ShowToolStrip").DefaultValue)
            _AutoUpdate = Boolean.Parse(My.Settings.Properties("AutoUpdate").DefaultValue)
            _EmailMessageText = DirectCast(My.Settings.Properties("EmailMessageText").DefaultValue, String)
            _CacheTimeout = Integer.Parse(My.Settings.Properties("CacheTimeout").DefaultValue)
            _SignInvoicesWithCompanySignature = Boolean.Parse(My.Settings.Properties("SignInvoicesWithCompanySignature").DefaultValue)
            _SignInvoicesWithLocalUserSignature = Boolean.Parse(My.Settings.Properties("SignInvoicesWithLocalUserSignature").DefaultValue)
            _SignInvoicesWithRemoteUserSignature = Boolean.Parse(My.Settings.Properties("SignInvoicesWithRemoteUserSignature").DefaultValue)
            _AllwaysLoginAsLocalUser = Boolean.Parse(My.Settings.Properties("AllwaysLoginAsLocalUser").DefaultValue)
            _ShowDefaultMailClientWindow = Boolean.Parse(My.Settings.Properties("ShowDefaultMailClientWindow").DefaultValue)
            _UseDefaultEmailClient = Boolean.Parse(My.Settings.Properties("UseDefaultEmailClient").DefaultValue)
            _AutoSizeForm = Boolean.Parse(My.Settings.Properties("AutoSizeForm").DefaultValue)
            _AutoSizeDataGridViewColumns = Boolean.Parse(My.Settings.Properties("AutoSizeDataGridViewColumns").DefaultValue)
            _AllwaysShowWageSettings = Boolean.Parse(My.Settings.Properties("AllwaysShowWageSettings").DefaultValue)
            _SQLQueryTimeOut = Integer.Parse(My.Settings.Properties("SQLQueryTimeOut").DefaultValue)
            ...
            _IgnoreWrongIBAN = Boolean.Parse(My.Settings.Properties("IgnoreWrongIBAN").DefaultValue)
            ...
            _AlwaysUseExternalIdInvoicesMade = Boolean.Parse(My.Settings.Properties("AlwaysUseExternalIdInvoicesMade").DefaultValue)
            _AlwaysUseExternalIdInvoicesReceived = Boolean.Parse(My.Settings.Properties("AlwaysUseExternalIdInvoicesReceived").DefaultValue)
            _DefaultInvoiceMadeItemIsGoods = Boolean.Parse(My.Settings.Properties("DefaultInvoiceMadeItemIsGoods").DefaultValue)
            _DefaultInvoiceReceivedItemIsGoods = Boolean.Parse(My.Settings.Properties("DefaultInvoiceReceivedItemIsGoods").DefaultValue)
            _CheckInvoiceReceivedNumber = Boolean.Parse(My.Settings.Properties("CheckInvoiceReceivedNumber").DefaultValue)
            _CheckInvoiceReceivedNumberWithDate = Boolean.Parse(My.Settings.Properties("CheckInvoiceReceivedNumberWithDate").DefaultValue)
            _CheckInvoiceReceivedNumberWithSupplier = Boolean.Parse(My.Settings.Properties("CheckInvoiceReceivedNumberWithSupplier").DefaultValue)
