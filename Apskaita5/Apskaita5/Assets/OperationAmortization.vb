...
#Region " Data Access "
        ...
        Private Overloads Sub DataPortal_Delete(ByVal criteria As Criteria)
            ...
            Dim persistence As OperationPersistenceObject = _
                OperationPersistenceObject.GetOperationPersistenceObject( _
                criteria.Id, LtaOperationType.Amortization)

            If persistence.IsComplexAct Then
                Throw New Exception(My.Resources.Assets_OperationAmortization_InvalidDeleteChild)
            End If

            Dim validator As OperationChronologicValidator = _
                OperationChronologicValidator.GetOperationChronologicValidator( _
                persistence.AssetID, LtaOperationType.Amortization, _
                LtaAccountChangeType.AcquisitionAccount, Today, criteria.Id, _
                persistence.OperationDate, Nothing)
            ...
            IndirectRelationInfoList.CheckIfJournalEntryCanBeDeleted( _
                persistence.JournalEntryID, DocumentType.Amortization)

            Using transaction As New SqlTransaction

                Try

                    General.JournalEntry.DeleteJournalEntryChild(persistence.JournalEntryID)
