...
Namespace Documents.BankDataExchangeProviders
    ...
    ''' <summary>
    ''' Represents a converter object that converts ISO20022 standard v. camt.053 (corrupted without version id)
    ...
    ''' If detects invalid version automaticaly downgrades to <see cref="ISO20022v053BankAccountStatement">v. camt.053 (not corrupted)</see>.</remarks>
    <Serializable()> _
    Public Class ISO20022v053corruptBankAccountStatement
        Inherits ISO20022v053BankAccountStatement
        ...
        Private Function GetBankAccountStatementItem(ByVal source As String) As BankAccountStatementItem
            ...
            End If
            result.Inflow = (GetISO20022ValueAsEntryType(document, "/Ntry/NtryDtls/TxDtls/CdtDbtInd", True) _
