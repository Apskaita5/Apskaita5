Namespace ActiveReports.Declarations
    ...
    ''' for a state social security administration (SODRA) report No. SD13 version 1.
    ''' </summary>
    ...
    <Serializable()> _
    Public Class DeclarationSD13_1
        Implements IDeclaration

        Private Const DECLARATION_NAME As String = "SD13 v.1"
        Private Const FILENAMEMXFDSD13_1 As String = "MXFD\13-SD-v01.mxfd"
        Private Const FILENAMEFFDATASD13_1 As String = "FFData\13-SD-v01.ffdata"
        ...
        Public Function GetFfDataDataSet(ByVal declarationDataSet As DataSet, _
            ...
            Dim declarationFilePath As String = IO.Path.Combine(AppPath(), FILENAMEFFDATASD13_1)
            ...
            formDataSet.Tables(1).Rows(0).Item(2) = IO.Path.Combine(AppPath(), FILENAMEMXFDSD13_1)
