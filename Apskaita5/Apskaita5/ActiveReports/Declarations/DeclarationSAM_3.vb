Namespace ActiveReports.Declarations
    ...
    ''' for a state social security administration (SODRA) report No. SAM version 3.
    ''' </summary>
    ...
    <Serializable()> _
    Public Class DeclarationSAM_3
        Implements IDeclaration

        Private Const DECLARATION_NAME As String = "SAM v.3"
        Private Const FILENAMEMXFDSAM03 As String = "MXFD\SAM-v03.mxfd"
        Private Const FILENAMEFFDATASAM03 As String = "FFData\SAM-v03.ffdata"
        ...
        Public Function GetFfDataDataSet(ByVal declarationDataSet As DataSet, _
            ...
            Dim declarationFilePath As String = IO.Path.Combine(AppPath(), FILENAMEFFDATASAM03)
            ...
            formDataSet.Tables(1).Rows(0).Item(2) = IO.Path.Combine(AppPath(), FILENAMEMXFDSAM03)
