Namespace Attributes
    ...
    ''' a language name value and to store basic business rules (mandatory, etc.).
    ''' </summary>
    ''' <remarks>Used for validation purposes in <see cref="LanguageNameValidation">LanguageNameValidation</see> method.
    ''' Could be used by GUI to initialize appropriate controls.</remarks>
    <Serializable()> _
    <AttributeUsage(AttributeTargets.Property, AllowMultiple:=False, Inherited:=True)> _
    Public Class LanguageNameFieldAttribute
        ...
        ''' language name for <see cref="HelperLists.CompanyRegionalInfo">CompanyRegionalInfoList</see>).
        ...
        ''' to a property (an empty string, because language names are provided 
        ...
        ''' <summary>
        ''' Creates a new LanguageNameFieldAttribute instance.
        ''' </summary>
        ...
        Public Function GetDataSource(ByVal valueObjectIds As List(Of String)) As IList _
            ...
            If _WithRegionalSettingsOnly Then
                Return CompanyRegionalInfoList.GetCachedFilteredList( _
                    Me.ValueRequired <> ValueRequiredLevel.Mandatory, False)
            Else
                Return GetLanguageNameList(Me.ValueRequired <> ValueRequiredLevel.Mandatory)
            End If
        End Function
        ...
        Public Function GetValidationRule() As Csla.Validation.RuleHandler _
            ...
            Return AddressOf CommonValidation.LanguageNameValidation
        End Function
