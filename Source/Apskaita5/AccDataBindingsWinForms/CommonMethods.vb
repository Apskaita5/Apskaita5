...
#Region " Form Management "
    ...
    Private Sub InitializeBusinessObjectsViews()
        ...
        _BusinessObjectsViews.Add(GetType(Documents.ProformaInvoiceMade), GetType(F_ProformaInvoiceMade))
...
#Region " Declarations "
    ...
    Private Sub InitializeAvailableIDeclarationList()
        ...
        _AvailableIDeclarationList.Add(New ActiveReports.Declarations.DeclarationGPM312_1)
        ...
        _AvailableIDeclarationList.Add(New ActiveReports.Declarations.DeclarationSAM_6)
        _AvailableIDeclarationList.Add(New ActiveReports.Declarations.DeclarationSAM_7)
