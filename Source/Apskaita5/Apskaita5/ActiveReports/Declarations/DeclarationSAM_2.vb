Namespace ActiveReports.Declarations
    ...
    Public Class DeclarationSAM_2
        ...
        Private Const FILENAMEMXFDSAM02 As String = "MXFD\SAM-v02.mxfd"
        Private Const FILENAMEFFDATASAM02 As String = "FFData\SAM-v02.ffdata"
        ...
        Public Function GetFfDataDataSet(ByVal declarationDataSet As DataSet, _
            ...
            Dim declarationFilePath As String = IO.Path.Combine(AppPath(), FILENAMEFFDATASAM02)
            ...
            formDataSet.Tables(1).Rows(0).Item(2) = IO.Path.Combine(AppPath(), FILENAMEMXFDSAM02)
