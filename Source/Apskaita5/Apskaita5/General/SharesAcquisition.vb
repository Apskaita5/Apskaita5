Namespace General
    ...
    ''' <summary>
    ''' Represents a shares acquisition (sub)operation (a person acquires some of the company shares).
    ''' </summary>
    ''' <remarks>Can only be used as a child object for <see cref="General.SharesAcquisitionList">SharesAcquisitionList</see>
    ''' Data is stored in database table SharesOperationDetails.</remarks>
    <Serializable()>
    Public NotInheritable Class SharesAcquisition
        Inherits BusinessBase(Of SharesAcquisition)
...
#Region " Business Methods "
        ...
        Private _IsEmission As Boolean = False
        ...
        ''' <summary>
        ''' |Gets or sets the person that acquired the shares.
        ''' </summary>
        ...
        ''' <summary>
        ''' Gets or sets the class of the shares acquired.
        ''' </summary>
        ...
        ''' <summary>
        ''' Gets or sets the amount of the shares acquired.
        ''' </summary>
        ...
        ''' <summary>
        ''' Gets or sets whether the source of the shares acquired is a new emission.
        ''' </summary>
        ''' <remarks>Data is stored in database field SharesOperationDetails.IsInternal.</remarks>
        Public Property IsEmission() As Boolean
            <System.Runtime.CompilerServices.MethodImpl(Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                Return _IsEmission
            End Get
        ...
        ''' <summary>
        ''' Gets or sets whether the person that acquired the shares is the company itself.
        ''' </summary>
        ...
        ''' <summary>
        ''' Gets or sets some arbitrary remarks regards regarding the shares acquired.
        ''' </summary>
        ...
        Public Overrides Function ToString() As String
            If _IsCompanyShares OrElse _ShareHolder = PersonInfo.Empty Then
                If _Class = SharesClassInfo.Empty Then
                    Return String.Format(My.Resources.General_SharesAcquisition_ToString,
...
#Region " Validation Rules "
        ...
        Private Shared Function ShareHolderValidation(ByVal target As Object,
            ...
            Dim valObj As SharesAcquisition = DirectCast(target, SharesAcquisition)
            ...
            ElseIf valObj._IsCompanyShares AndAlso valObj._ShareHolder <> PersonInfo.Empty Then
                ...
                e.Description = My.Resources.General_SharesAcquisition_ShareHolderInvalid
...
#Region " Factory Methods "
        ...
        Friend Shared Function NewSharesAcquisition() As SharesAcquisition
            Dim result As New SharesAcquisition
            result.ValidationRules.CheckRules()
            Return result
        End Function

        Friend Shared Function GetSharesAcquisition(ByVal dr As DataRow) As SharesAcquisition
            Return New SharesAcquisition(dr)
        End Function
...
#Region " Data Access "
        ...
        Private Sub Fetch(ByVal dr As DataRow)
            ...
            _IsEmission = ConvertDbBoolean(CIntSafe(dr.Item(3), 0))
        ...
        Friend Sub Insert(ByVal parent As SharesOperation)
            ...
            myComm.AddParam("?AA", ConvertDatabaseID(SharesOperationType.Acquisition))
        ...
        Private Sub AddWithParams(ByRef myComm As SQLCommand)
            ...
            myComm.AddParam("?AD", ConvertDbBoolean(_IsEmission))
