...
Namespace Assets
    ...
    <Serializable()> _
    Public NotInheritable Class OperationAccountChange
...
#Region " Business Methods "
        ...
        Public ReadOnly Property AccountTypeHumanReadable() As String
            <System.Runtime.CompilerServices.MethodImpl(Runtime.CompilerServices.MethodImplOptions.NoInlining)> _
            Get
                Return Utilities.ConvertLocalizedName(_AccountType)
            End Get
        End Property
...
#Region " Data Access "
        ...
        Private Sub Fetch(ByVal persistence As OperationPersistenceObject, _
            ...
            _ChronologyValidator = OperationChronologicValidator.GetOperationChronologicValidator( _
                _Background, LtaOperationType.AccountChange, _AccountType, _ID, _Date, parentValidator)
