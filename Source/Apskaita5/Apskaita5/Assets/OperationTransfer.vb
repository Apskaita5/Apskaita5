...
Namespace Assets
    ...
    ''' <summary>
    ''' Represents a long term asset transfer (sale etc.) operation.
    ''' </summary>
...
#Region " Business Methods "
        ...
        Private _AmountToTransfer As Integer = 0
        ...
        ''' <summary>
        ''' Gets a type of the long term asset operation, i.e. <see cref="LtaOperationType.Transfer">LtaOperationType.Transfer</see>.
        ''' </summary>
        ''' <remarks></remarks>
        Public ReadOnly Property [Type]() As LtaOperationType
            <System.Runtime.CompilerServices.MethodImpl(Runtime.CompilerServices.MethodImplOptions.NoInlining)> _
            Get
                Return LtaOperationType.Transfer
            End Get
        End Property
        ...
        ''' is used to validate a long term asset transfer operation chronological business rules.</remarks>
...
#End Region
        ...
        ''' that is attached to the long term asset transfer operation.
        ''' </summary>
        ...
        ''' <summary>
        ''' Gets or sets an amount of the long term asset to transfer.
        ''' </summary>
        ...
        Public Property AmountToTransfer() As Integer
            <System.Runtime.CompilerServices.MethodImpl(Runtime.CompilerServices.MethodImplOptions.NoInlining)> _
            Get
            ...
            Set(ByVal value As Integer)
                CanWriteProperty(True)
                If AmountToTransferIsReadOnly Then Exit Property
                If _AmountToTransfer <> value Then
        ...
        ''' <summary>
        ''' Whether the <see cref="AmountToTransfer">AmountToTransfer</see> property is readonly.
        ''' </summary>
        ''' <remarks></remarks>
        Public ReadOnly Property AmountToTransferIsReadOnly() As Boolean
            <System.Runtime.CompilerServices.MethodImpl(Runtime.CompilerServices.MethodImplOptions.NoInlining)> _
            Get
        ...
        Private Sub Recalculate(ByVal raisePropertyChanged As Boolean)
            ...
            _Background.ChangeAssetAmount = -_AmountToTransfer

            Dim applicableAmount As Integer = _AmountToTransfer
            If (_Background.CurrentAssetAmount - _AmountToTransfer) < 0 Then
        ...
        Public Sub LoadAssociatedJournalEntry(ByVal entry As ActiveReports.JournalEntryInfo)
            ...
            If Not Array.IndexOf(ParentJournalEntryTypes, entry.DocType) < 0 Then
                Throw New Exception(String.Format(My.Resources.Assets_OperationTransfer_CannotAttachParentType, _
                    entry.DocTypeHumanReadable))
            ElseIf Array.IndexOf(AllowedJournalEntryTypes, entry.DocType) < 0 Then
                Throw New Exception(String.Format(My.Resources.Assets_OperationTransfer_InvalidJournalEntryType, _
                    entry.DocTypeHumanReadable))
            End If
        ...
        ''' that contains all the book entries requered for transfer by the
        ...
        Public Overrides Function Save() As OperationTransfer
        ...
        Public Overrides Function ToString() As String
            If IsChild Then
                Return String.Format(My.Resources.Assets_OperationTransfer_ToStringChild, _
                _Background.AssetName, _ID.ToString())
            Else
                Return String.Format(My.Resources.Assets_OperationTransfer_ToString, _
...
#Region " Validation Rules "
        ...
        Private Shared Function JournalEntryIDValidation(ByVal target As Object, _
          ByVal e As Validation.RuleArgs) As Boolean
            ...
            If Not DirectCast(target, OperationTransfer).IsChild AndAlso _
                Not DirectCast(target, OperationTransfer).JournalEntryID > 0 Then
                e.Description = My.Resources.Assets_OperationTransfer_JournalEntryNull
        ...
        Private Shared Function DateValidation(ByVal target As Object, _
          ByVal e As Validation.RuleArgs) As Boolean
            ...
            Dim valObj As OperationTransfer = DirectCast(target, OperationTransfer)

            If Not valObj.IsChild AndAlso valObj.JournalEntryID > 0 AndAlso _
                valObj._Date.Date <> valObj._JournalEntryDate.Date Then
                e.Description = My.Resources.Assets_OperationTransfer_DateInvalid
                e.Severity = RuleSeverity.Error
                Return False
            End If
...
#Region " Factory Methods "
        ...
        ''' <summary>
        ''' Gets a new OperationTransfer instance as a parent (standalone) document.
        ''' </summary>
        ''' <param name="assetId">An ID of the asset that the operation operates on.</param>
        ''' <remarks></remarks>
        Public Shared Function NewOperationTransfer(ByVal assetId As Integer) As OperationTransfer
            Return DataPortal.Create(Of OperationTransfer)(New Criteria(assetId))
        End Function

        ''' <summary>
        ''' Gets a new OperationTransfer instance as a child of some parent document.
        ''' </summary>
        ''' <param name="assetId">An ID of the asset that the operation operates on.</param>
        ...
        ''' <remarks></remarks>
        Friend Shared Function NewOperationTransferChild(ByVal assetId As Integer, _
            ByVal parentValidator As IChronologicValidator, _
            ByVal parentIsComplexAct As Boolean) As OperationTransfer
            Return New OperationTransfer(assetId, parentValidator, parentIsComplexAct)
        End Function


        ''' <summary>
        ''' Gets an existing OperationTransfer instance from a database 
        ''' as a parent (standalone) document.
        ''' </summary>
        ''' <param name="id">An <see cref="OperationTransfer.ID">ID of the operation</see> 
        ''' or an <see cref="OperationTransfer.JournalEntryID">ID the journal entry</see>  
        ''' that is attached to the operation.</param>
        ''' <param name="nFetchByJournalEntryID">Whether the <paramref name="id">id</paramref>
        ''' param is an <see cref="OperationTransfer.JournalEntryID">ID the journal entry</see> 
        ''' that is attached to the operation.</param>
        ''' <remarks></remarks>
        Public Shared Function GetOperationTransfer(ByVal id As Integer, _
            ByVal nFetchByJournalEntryID As Boolean) As OperationTransfer
            Return DataPortal.Fetch(Of OperationTransfer) _
        ...
        ''' </summary>
        ''' <param name="operationID">An <see cref="OperationTransfer.ID">ID of the operation</see>
        ''' to fetch.</param>
        ''' <param name="parentValidator">A parent document's IChronologyValidator.</param>
        ''' <remarks>An overload for the parent documents that do not support bulk 
        ''' background and chronology data loading.</remarks>
        Friend Shared Function GetOperationTransferChild(ByVal operationID As Integer, _
            ByVal parentValidator As IChronologicValidator) As OperationTransfer
            Return New OperationTransfer(operationID, parentValidator)
        End Function
        ...
        ''' (could be null, if the parent document does not support bulk background data fetch)</param>
        ''' <remarks></remarks>
        Friend Shared Function GetOperationTransferChild( _
            ByVal persistence As OperationPersistenceObject, _
            ByVal parentValidator As IChronologicValidator, _
            ByVal generalData As DataTable, ByVal deltaData As DataTable) As OperationTransfer
            Return New OperationTransfer(persistence, parentValidator, generalData, deltaData)
        End Function


        ''' <summary>
        ''' Deletes an existing OperationTransfer instance from a database.
        ''' </summary>
        ''' <param name="id">An <see cref="OperationTransfer.ID">ID of the operation</see> 
        ''' to delete.</param>
        ''' <remarks></remarks>
        Public Shared Sub DeleteOperationTransfer(ByVal id As Integer)
            DataPortal.Delete(New Criteria(id))
        End Sub

        ''' <summary>
        ''' Deletes an existing OperationTransfer child instance from a database.
        ''' </summary>
        ...
        Friend Sub DeleteOperationTransferChild()
            DoDelete(_ID)
        End Sub
...
#Region " Data Access "
        ...
        Private Sub Create(ByVal nAssetId As Integer, _
            ...
            _ChronologyValidator = OperationChronologicValidator.NewOperationChronologicValidator( _
                _Background, LtaOperationType.Transfer, parentValidator)
        ...
        Private Sub Fetch(ByVal operationID As Integer, ByVal parentValidator As IChronologicValidator)
            ...
            Dim persistence As OperationPersistenceObject = _
                ...
                operationID, LtaOperationType.Transfer)
        ...
        Private Sub Fetch(ByVal persistence As OperationPersistenceObject, _
            ...
            _AmountToTransfer = persistence.AmmountChange
            _JournalEntryID = persistence.JournalEntryID
            ...
            _ChronologyValidator = OperationChronologicValidator.GetOperationChronologicValidator( _
                _Background, LtaOperationType.Transfer, _ID, _Date, parentValidator)
        ...
        Private Function GetPersistenceObject() As OperationPersistenceObject
            ...
            If IsNew Then
                result = OperationPersistenceObject.NewOperationPersistenceObject( _
                    LtaOperationType.Transfer, _Background.AssetID)
            ...
            result.AmmountChange = _AmountToTransfer
        ...
        Private Overloads Sub DataPortal_Delete(ByVal criteria As Criteria)
            ...
            Dim operationToDelete As New OperationTransfer
            operationToDelete.Fetch(criteria.Id, Nothing)

            If operationToDelete.IsComplexAct Then
                Throw New Exception(My.Resources.Assets_OperationTransfer_InvalidDeleteComplexDocumentChild)
            ElseIf Not Array.IndexOf(ParentJournalEntryTypes, operationToDelete._JournalEntryDocumentType) < 0 Then
                Throw New Exception(String.Format(My.Resources.Assets_OperationTransfer_InvalidDeleteChild, _
                    operationToDelete.JournalEntryDocumentType))
            End If

            If Not operationToDelete.ChronologyValidator.FinancialDataCanChange Then
                Throw New Exception(String.Format(My.Resources.Assets_OperationTransfer_InvalidDelete, _
        ...
        Friend Sub CheckIfCanDeleteChild(ByVal parentValidator As IChronologicValidator)
            ...
            _ChronologyValidator = OperationChronologicValidator.GetOperationChronologicValidator( _
                _Background, LtaOperationType.Transfer, _
        ...
        Private Sub ReloadBackgroundAndChronology(ByVal parentValidator As IChronologicValidator)
            ...
            Else
                _ChronologyValidator = OperationChronologicValidator.GetOperationChronologicValidator( _
                    _Background, LtaOperationType.Transfer, _ID, _
