...
Friend Class F_OperationTransfer
    ...
    Private _DocumentToEdit As OperationTransfer = Nothing
    ...
    Public Sub New(ByVal documentToEdit As OperationTransfer)
    ...
    Private Sub F_OperationTransfer_Load(ByVal sender As System.Object, _
        ...
        If _DocumentToEdit Is Nothing Then
            'OperationTransfer.NewOperationTransfer(_AssetID)
            _QueryManager.InvokeQuery(Of OperationTransfer)(Nothing, _
                "NewOperationTransfer", True, AddressOf OnNewOperationLoaded, _AssetID)
        Else
    ...
    Private Function SetDataSources() As Boolean
        ...
        Try
            ...
            BackgroundInfoPanel1.GetBindingSource.DataSource = OperationTransferBindingSource
    ...
    Private Sub OnNewOperationLoaded(ByVal result As Object, ByVal exceptionHandled As Boolean)
        ...
        _DocumentToEdit = DirectCast(result, OperationTransfer)
    ...
    Public Sub OnPrintClick(ByVal sender As Object, ByVal e As System.EventArgs) _
        ...
        Try
            PrintObject(_FormManager.DataSource, False, 0, "ITPerleidimas", Me, "")
        Catch ex As Exception
            ShowError(ex)
        End Try
    ...
    Public Sub OnPrintPreviewClick(ByVal sender As Object, ByVal e As System.EventArgs) _
        ...
        Try
            PrintObject(_FormManager.DataSource, True, 0, "ITPerleidimas", Me, "")
        Catch ex As Exception
            ShowError(ex)
        End Try
    ...
    Private Sub ConfigureButtons()
        ...
        AmountToTransferAccTextBox.ReadOnly = (_FormManager.DataSource Is Nothing OrElse _FormManager.DataSource.AmountToTransferIsReadOnly)
