Namespace ActiveReports.Declarations
    ...
    ''' for a state tax inspectorate (VMI) report No. FR0573 version 3.
    ''' </summary>
    ...
    <Serializable()> _
    Public Class DeclarationFR0573_3
        Implements IDeclaration

        Private Const DECLARATION_NAME As String = "FR0573 v.3"
        Private Const FILENAMEMXFDFR0573_3 As String = "MXFD\FR0573(3).mxfd"
        Private Const FILENAMEFFDATAFR0573_3 As String = "FFData\FR0573(3).ffdata"
        ...
        Public Function GetFfDataDataSet(ByVal declarationDataSet As DataSet, _
            ...
            Dim declarationFilePath As String = IO.Path.Combine(AppPath(), FILENAMEFFDATAFR0573_3)
            ...
            formDataSet.Tables(1).Rows(0).Item(2) = IO.Path.Combine(AppPath(), FILENAMEMXFDFR0573_3)
